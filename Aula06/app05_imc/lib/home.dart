...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(
      title: Text("Cáculo do IMC"),
      centerTitle: true,
      backgroundColor: Color.fromARGB(255, 114, 23, 0),
    ),
    backgroundColor: Color.fromARGB(255, 219, 151, 142),
    ...
    buildContainerButton(BuildContext context) {
      return Container(
        ...
        child: RaisedButton(
          ...
          color: Color.fromARGB(255, 131, 15, 0),
          ),
      );
   ...
   void calcula() {
     ...
     if(resultado < 18.5) {
       _infoText = "Resultado IMC : (${resultado.toStringAsPrecision(2)})\n\nAbaixo do Peso";
